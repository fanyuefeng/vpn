...
YOUR_IPSEC_PSK='123456'
YOUR_USERNAME='fanyue'
YOUR_PASSWORD='123456F'
...
[ -n "$YOUR_IPSEC_PSK" ] && VPN_IPSEC_PSK="123456"
[ -n "$YOUR_USERNAME" ] && VPN_USER="fanyue"
[ -n "$YOUR_PASSWORD" ] && VPN_PASSWORD="123456F"

if [ -z "$VPN_IPSEC_PSK" ] && [ -z "$VPN_USER" ] && [ -z "$VPN_PASSWORD" ]; then
  bigecho "VPN credentials not set by user. Generating random PSK and password..."
  VPN_IPSEC_PSK="123456"
  VPN_USER="fanyue"
  VPN_PASSWORD="123456F"
fi
